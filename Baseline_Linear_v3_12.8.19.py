#(for baseline model: dijt is read by Zhiheng's data as parameter, no Dijcst in model)
...
#assign dijt-(i=20,j=20,t=4), total 40 time periods but now only use 4
d = np.zeros((20,20,4), dtype = np.float )
...
print(d[0,0,0],d[19,19,0])
print(d[0,0,1],d[19,19,1])
print(d[0,0,2],d[19,19,2])
print(d[0,0,3],d[19,19,3])
#print('\n')

#step1-assign parameters (i=j=t=2) - set subjectively
#assign cijt-(i=j=t=2)
c = np.zeros((20,20,4), dtype = np.int)
